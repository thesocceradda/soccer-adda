...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.socceradda.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.socceradda.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.socceradda.domain.User.class.getName());
            createCache(cm, com.socceradda.domain.Authority.class.getName());
